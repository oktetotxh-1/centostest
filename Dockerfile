FROM centos
RUN yum update -y
RUN DEBIAN_FRONTEND=noninteractive yum install ssh apache2-bin apache2-data apache2-utils init apache2 wget npm apache2 php php-curl mysql-server php-cli php-fpm php-json php-common php-mysql php-zip php-gd php-mbstring php-xml php-pear php-bcmath -y
